...
#'
#' @export
ba <- function(dbh, expansion, imperial_units = TRUE) {
    .Call(`_biometrics_utilities_ba`, dbh, expansion, imperial_units)
}
...
#'
#' @export
cch <- function(species, dbh, height, crown_length, dacb, lcw, expansion, parameters, imperial_units = TRUE) {
    .Call(`_biometrics_utilities_cch`, species, dbh, height, crown_length, dacb, lcw, expansion, parameters, imperial_units)
}
...
#'
#' @export
dominant_dbh <- function(height, dbh, expansion, dominant_cohort_size, method = 0L) {
    .Call(`_biometrics_utilities_dominant_dbh`, height, dbh, expansion, dominant_cohort_size, method)
}
...
#'
#' @export
APA <- function(x, y, dbh, plot_x, plot_y, weighted = TRUE) {
    .Call(`_biometrics_utilities_APA`, x, y, dbh, plot_x, plot_y, weighted)
}
...
#'
#' @export
APA_Polygons <- function(tree_id, x, y, dbh, plot_x, plot_y, weighted = FALSE) {
    .Call(`_biometrics_utilities_APA_Polygons`, tree_id, x, y, dbh, plot_x, plot_y, weighted)
}
